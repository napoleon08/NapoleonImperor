...
st.write(
    "일별 박스오피스 TOP 10 영화의 관객수를 합산하여 "
    "관객이 가장 많았던 날짜 3일을 찾습니다."
)
...
event_map = {
    "2025-12-25": "성탄절",
    "2026-08-08": "여름 방학의 주말",
    "2026-08-16": "광복절 다음 날, 방학 중 일요일"
}
...
st.write(
    "영화 데이터만 살펴보았지만, 관객수가 크게 증가한 날짜를 "
    "달력과 비교하면 주말이나 공휴일과 같은 사회적 리듬을 "
    "확인할 수 있습니다."
)
...
st.warning(
    "⚠️ 이 값은 해당 날짜의 모든 극장 관객 수가 아닙니다. "
    "일별 박스오피스 10위권에 포함된 영화들의 일관객을 합산한 값입니다. "
    "11위 이하 영화의 관객은 포함되지 않습니다."
)
